        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/manage/admin_doproductupdate" method="post"  enctype="multipart/form-data" id="myform" name="myform">
                    <input type="hidden" name="id" value="${p1.PRODUCT_ID }">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="productName" size="50" value="${p1.PRODUCT_NAME}" type="text">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="productPrice" size="50" value="${p1.PRODUCT_PRICE}" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>商品介绍：</th>
                            <td>
                                <input class="common-text required" id="title" name="productDesc" size="50" value="${p1.PRODUCT_DESCRIPTION}" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>商品库存：</th>
                            <td>
                                <input class="common-text required" id="title" name="productStock" size="50" value="${p1.PRODUCT_STOCK}" type="text">
                            </td>
                        </tr>
